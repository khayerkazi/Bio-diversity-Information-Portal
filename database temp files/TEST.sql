...
-- Generated 2011.12.16 01:51:19 by RATUL
-- This script can be run in sqlplus as the owner of the Oracle Apex owner.
begin
    wwv_flow_api.set_security_group_id(p_security_group_id=>4878326467070046);
end;
/
----------------
-- W O R K S P A C E
...
wwv_flow_fnd_user_api.create_company (
  p_id                           => 4878429997070102,
  p_provisioning_company_id      => 4878326467070046,
  p_short_name                   => 'TEST',
  p_first_schema_provisioned     => 'TEST',
  p_company_schemas              => 'TEST',
...
wwv_flow_fnd_user_api.create_fnd_user (
  p_user_id      => '4878231185070046',
  p_user_name    => 'RATUL',
  p_first_name   => '',
  p_last_name    => '',
  p_description  => '',
  p_email_address=> '',
  p_web_password => '679526F5FBD425BDE5B942AFFCD54F1A',
  p_web_password_format => 'HEX_ENCODED_DIGEST_V2',
  p_group_ids    => '',
  p_developer_privs=> 'ADMIN:CREATE:DATA_LOADER:EDIT:HELP:MONITOR:SQL',
  p_default_schema=> 'TEST',
  p_account_locked=> 'N',
  p_account_expiry=> to_date('201112141659','YYYYMMDDHH24MI'),
