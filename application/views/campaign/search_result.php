<div id="wrapper">
    ...
    <div id="center_content">
        ...
        <?php echo form_open('campaign/campaign/manage_campaign')?>
        <div class="project_list">
          ...
          <table width="90%" border="0" align="center" class="project_list">
            <tr class="project_list">
              ...
              <th scope="col" class="project_list">Campaigners</th>
            </tr>
            <tr>
            ...
            ?>
              ...
              <th scope="col" class="project_list">
                  <a href="<?php echo base_url().'index.php/campaign/campaign/manage_campaign/'.$data[$index]['CAMPAIGN']['CAMPAIGNID']?>">
                    <?php echo 'Id: '.$data[$index]['CAMPAIGN']['CAMPAIGNID'].'<br/>'. 'Title: '.$data[$index]['CAMPAIGN']['TITLE'].'<br/>'.'Created: '.$data[$index]['CAMPAIGN']['STARTTIME'].'<br/>'.'Duration: '.$data[$index]['CAMPAIGN']['FINISHTIME'];?>
                  </a>
             </th>
              <th scope="col" class="project_list">
