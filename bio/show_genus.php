...
<?php 
        ...
        $genus = GET_CLASSIFICATION_DETAIL($connect, "GENUS", $gid);
...
#apDiv4 {
  ...
  <table width="200" height="115" border="2" cellpadding="3" cellspacing="3">
    <tr>
      <td><table width="588" height="67" border="2"  >
    <tr>
    ...
    <tr>
      <td><form action="show_GENUS.php" method="post">
  <table width="254" border="1" cellspacing="3" cellpadding="3">
    <tr>
...
?>'>
	...
	if(isset($_POST['PDESC']))
		...
		echo "GENUS DESCRIPTION:<br/>".$genus['DESCRIPTION']."<br/>"."->LAST MODIFIED(".$genus['LASTMODIFIED'].")";
?></td>
    </tr>
  </table>
</div>
